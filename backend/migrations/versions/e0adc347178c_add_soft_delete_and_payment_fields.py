...
def upgrade() -> None:
    ...
    op.add_column('bookings', sa.Column('is_deleted', sa.Boolean(), server_default='false', nullable=False))
    ...
    op.add_column('courts', sa.Column('is_deleted', sa.Boolean(), server_default='false', nullable=False))
    ...
    op.add_column('payments', sa.Column('gateway_fee', sa.Numeric(precision=10, scale=2), nullable=True))
