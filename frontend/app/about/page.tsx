        ...
        <section className="px-4 py-16 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              ...
              سالن‌های والیبال، بسکتبال، فوتسال و هندبال را بر اساس موقعیت، قیمت
              و امکانات مقایسه کرده و در لحظه سانس مورد نظر خود را رزرو کنند.
              مدیران سالن‌ها نیز ابزار کاملی برای مدیریت سانس‌ها، مشاهده درآمد و
              پاسخ به نظرات کاربران در اختیار دارند.
            </motion.p>
          </div>
        </section>
                ...
                <Card className="h-full">
                  ...
                  <CardContent>
                    <p className="leading-relaxed text-muted-foreground">
                      ...
                      ورزشکاری بتواند در هر شهر ایران، سالن مورد نظر خود را در
                      چند ثانیه پیدا و رزرو کند.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
