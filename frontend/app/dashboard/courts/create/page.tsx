  ...
  return (
    <div className="pb-12">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">ثبت مجموعه ورزشی جدید</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          اطلاعات مجموعه ورزشی خود را وارد کنید. پس از تأیید مدیریت، در دسترس کاربران قرار می‌گیرد.
        </p>
      </div>
        ...
        <div className="rounded-xl border bg-card p-6">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">نام و مشخصات اصلی مجموعه</p>
            </div>
          </div>
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">حداقل یک نوع ورزش را انتخاب کنید</p>
              ...
              {errors.sport_types?.message && (
                <p className="text-xs text-destructive">{String(errors.sport_types.message)}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card p-6">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">مکان دقیق مجموعه را مشخص کنید</p>
            </div>
          </div>
          <div className="space-y-5">
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">روی نقشه کلیک کنید یا نشانگر را بکشید</p>
              <LocationPicker
        ...
        <div className="rounded-xl border bg-card p-6">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">تعداد نفراتی که هم‌زمان می‌توانند حضور داشته باشند</p>
            </div>
          </div>
          <div className="space-y-1.5">
        ...
        <div className="rounded-xl border bg-card p-6">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">امکانات موجود در مجموعه را انتخاب کنید</p>
            </div>
          </div>
          <AmenityCheckboxes
        ...
        <div className="rounded-xl border bg-card p-6">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">حداقل ۳ تصویر از مجموعه آپلود کنید</p>
            </div>
          </div>
          <ImageUpload
            images={courtImages}
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:text-right">
            <div className="flex-1 text-center sm:text-right">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                و تا قبل از تأیید در لیست عمومی نمایش داده نمی‌شود.
              </p>
            </div>
            <Button
              type="submit"
